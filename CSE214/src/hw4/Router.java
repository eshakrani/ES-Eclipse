...
public class Router {
	 ...
	 * 
	 * @return - int the maximum buffer size of the Routers in this sim.
	 */
	 ...
	 * 
	 * @postcondition maximum buffer size of the Routers has been set to param
	 *                maxBufferSize
	 */
	 ...
	 * no-arg constructor
	 * 
	 * @postcondition new Router object has been created
	 * 
	 * @postcondition front and rear of the Router have been set to null
	 * 
	 * @postcondition size of the Router has been set to 0
	 */
	public Router() {
		this.front = null;
		this.rear = null;
	 ...
	 * 
	 * @postcondition packet has been added to the rear of the Router
	 * 
	 * @postcondition size of the Router has been incremented by 1
	 */
	 ...
	 * dequeue method
	 * 
	 * @return Packet object - the Packet in the RouterNode at the front of the
	 *         Router
	 * 
	 * @throws EmptyRouterException if used on an empty Router object
	 * 
	 * @postcondition the RouterNode at the front of the Router has been removed
	 * 
	 * @postcondition (if applicable) size of the Router has been decremented by
	 *                1
	 */
	 ...
	 * size method
	 * 
	 * @return - int number of Packets in the Router
	 */
	public int size() {
		return this.size;
	}
	 ...
	 * isEmpty method
	 * 
	 * @return boolean - true if Router is empty (head is null) false otherwise
	 */
	 ...
	 * toString method
	 * 
	 * @return String - String representation of the Router
	 */
	 ...
	 * 
	 * @return Router object - the router in the param routers with the smallest
 ...
 * @author eshak
 *
 *         represents a Node of the Router queue
 */
class RouterNode {
	private Packet data;
	 ...
	 * getData method
	 * 
	 * @return - Packet object the Packet data of the current RouterNode
	 */
	 ...
	 * 
	 * @postcondition the data of the current RouterNode has been set to param
	 *                data
	 */
	 ...
	 * getNext method
	 * 
	 * @return - RouterNode object next RouterNode to current RouterNode
	 */
	 ...
	 * 
	 * @postcondition current RouterNode's next RouterNode has been set to param
	 *                next
	 */
	 ...
	 * getPrev method
	 * 
	 * @return - RouterNode object previous RouterNode to current RouterNode
	 */
	 ...
	 * 
	 * @postcondition current RouterNode's previous RouterNode has been set to
	 *                param prev
	 */
	 ...
	 * 
	 * @postcondition next, prev, data all set to null
	 */
	public RouterNode() {
	}
	 ...
	 * 
	 * @postcondition data of RouterNode has been set to param packet
	 */
